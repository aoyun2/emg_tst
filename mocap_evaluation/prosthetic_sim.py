...
class _MuJoCoRunner:
    ...
    def run(
        ...
        # Actuator order (N_ACT_PER_HUMANOID = 27 per humanoid):
        ...
        def _fill_humanoid(off, knee_signal):
            ...
            # Spine/neck/head: negate because MuJoCo axis +Y = backward lean
            # but BVH Xrotation positive = forward lean.
