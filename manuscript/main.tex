...
($\rho=+0.327$ across the
14 checkpoint means). An exploratory two-segment split, placed between adjacent
levels, falls at 12.97$^{\circ}$ (95\% CI
12.04 to 14.25$^{\circ}$). Above it, worse prediction
gave more instability (slope
+0.01304~s per
degree, 95\% CI 0.00986 to 0.01699). Below it
...
simulated outcome (+0.0053~s, 95\% CI
-0.0069 to 0.0175; $p=0.386$).}
...
covariate. The 80 windows drew on 32 distinct
snippets, the most frequent covering 15 of them. Because no
...
10$^{\circ}$ tracking criterion on every
...
shortens. 20 of the 1120 rollouts ended before the
full 34 steps, which shortens the outcome for the windows that
...
0.018 to 0.281$^{\circ}$;
$t(89)=2.26$, $p=0.026$). Three surrogate
controls are reported in Table~\ref{tab:controls}.
The recorded signal outperformed all three surrogates in paired within-participant comparisons (smallest margin 0.288$^{\circ}$, all $p\leq1.68\times10^{-7}$). The circular-shift surrogate retained
0.17 of the
...
the residual-fusion and no-sEMG conditions was +0.0053~s (95\% CI -0.0069 to 0.0175;
$t(64)=0.87$, $p=0.386$). The
...
12.97$^{\circ}$ (95\% CI
12.04 to 14.25$^{\circ}$); the split can therefore
...
+0.01304~s per
degree, 95\% CI 0.00986 to 0.01699).
...
95\% CI -0.00978 to -0.00466). Both intervals exclude
...
Across the 80 windows, the within-window Spearman correlation between a window's own accuracy and its own excess instability averaged +0.150 over the 65 participants they come from (95\% CI 0.013 to 0.280; $t(64)=2.19$, $p=0.032$), with 44 of 65 participants positive. Pooled across all 1120 checkpoint--window pairs
the match-adjusted association was
+0.063 (participant-level cluster bootstrap 95\% CI
-0.019 to 0.150). Figure~\ref{fig:fwl} shows the
...
\midrule
400001 & 80 & 5.09 & 1.28 & +0.0267 & -0.004 & -0.209 to 0.206 \\
28246 & 80 & 6.56 & 1.78 & +0.0184 & -0.054 & -0.279 to 0.191 \\
2457 & 80 & 8.05 & 1.82 & +0.0061 & -0.014 & -0.228 to 0.208 \\
521 & 80 & 9.54 & 2.04 & -0.0143 & +0.051 & -0.188 to 0.292 \\
216 & 80 & 11.05 & 2.20 & -0.0158 & -0.085 & -0.324 to 0.175 \\
106 & 80 & 11.75 & 2.05 & -0.0202 & -0.028 & -0.236 to 0.184 \\
74 & 80 & 12.51 & 1.85 & -0.0230 & +0.076 & -0.148 to 0.299 \\
55 & 80 & 13.43 & 1.71 & -0.0247 & -0.007 & -0.251 to 0.228 \\
41 & 80 & 14.46 & 1.65 & -0.0148 & +0.001 & -0.223 to 0.218 \\
30 & 80 & 15.56 & 1.66 & -0.0074 & -0.089 & -0.287 to 0.119 \\
21 & 80 & 16.69 & 1.74 & +0.0126 & -0.071 & -0.290 to 0.165 \\
13 & 80 & 17.88 & 1.87 & +0.0313 & -0.007 & -0.271 to 0.247 \\
6 & 80 & 19.09 & 2.05 & +0.0466 & -0.093 & -0.323 to 0.158 \\
0 & 80 & 20.25 & 2.23 & +0.0605 & -0.071 & -0.318 to 0.194 \\
\bottomrule
\end{tabular}
\end{table}
...
The most accurate model evaluated here reached 5.09$^{\circ}$, which
...
prediction degraded
(+0.150,
95\% CI 0.013 to 0.280, $p=0.032$,
44 of 65 participants
positive). The
...
12.97$^{\circ}$ (95\% CI
12.04 to 14.25$^{\circ}$) a less accurate model
...
+0.0053~s in excess instability (95\% CI
-0.0069 to 0.0175; $p=0.386$), which is the same
