...
because a periodic surrogate does not fall to zero on its own. The recorded signal outperformed all three surrogates in paired within-participant comparisons (smallest margin 0.288$^{\circ}$, all $p\leq1.68\times10^{-7}$).
