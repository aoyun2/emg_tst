...
-0.202 to 0.030$^{\circ}$;
$p=0.160$). The surrogate controls
(Supplementary Table~\ref{tab:controls}) agreed. The recorded signal outperformed all 3 surrogates in paired within-participant comparisons (smallest margin 0.288$^{\circ}$, all $p<10^{-6}$).
...
periodic-signal surrogate cannot be expected to do. The recorded signal outperformed all 3 surrogates in paired within-participant comparisons (smallest margin 0.288$^{\circ}$, all $p<10^{-6}$).
...
\midrule
Recorded sEMG & +0.345 & 0.254 to 0.436 & $<10^{-6}$ & --- & --- \\
Circular shift & +0.058 & 0.005 to 0.113 & $0.040$ & 0.17 & +0.288 ($p<10^{-6}$) \\
Participant swap & -0.011 & -0.048 to 0.026 & $0.557$ & -0.03 & +0.357 ($p<10^{-6}$) \\
Phase randomized & -0.022 & -0.055 to 0.008 & $0.170$ & -0.07 & +0.368 ($p<10^{-6}$) \\
\bottomrule
\end{tabular}
\end{table}
