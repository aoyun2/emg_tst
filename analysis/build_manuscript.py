...
walker. This is a question about what the reported accuracy measures, not about
whether the signal would exist on a device, since a microprocessor knee carries a
joint angle encoder, so knee-angle history is available at inference.
