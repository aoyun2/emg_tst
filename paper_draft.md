...
**Knee tracking.** PRED reduced simulated knee RMSE relative to REF in 71.3% of trials (57/80; mean REF 12.09° vs. PRED 9.60°, mean improvement 2.49°; Wilcoxon signed-rank, *p* < 0.001).

**Balance-risk threshold crossings.** Despite improved knee tracking, the balance-risk threshold was crossed in **32/80 (40.0%) of REF trials** versus **64/80 (80.0%) of PRED trials**—a doubling of the high-risk event rate. Among PRED trials that crossed the threshold, the mean onset step was 30/67 (≈ 0.90 s into the 2.01 s window), indicating that destabilisation occurred well before the end of the rollout rather than only at its edge. Excess instability AUC was positive in 95.0% of all trials (mean $\Delta_{\text{AUC}}$ = 0.208, SD = 0.186; Wilcoxon one-sided test vs. zero, *p* < 0.001).
